...
#include "ernest_controller/ernest_controller.hpp"
...
ErnestController::ErnestController() : controller_interface::ControllerInterface() {}

controller_interface::return_type ErnestController::init(const std::string & controller_name)
{
...
InterfaceConfiguration ErnestController::command_interface_configuration() const
{
...
InterfaceConfiguration ErnestController::state_interface_configuration() const
{
  std::vector<std::string> conf_names;
  for (const auto & joint_name : left_wheel_names_)
  {
...
controller_interface::return_type ErnestController::update()
{
...
CallbackReturn ErnestController::on_configure(const rclcpp_lifecycle::State &)
{
  auto logger = node_->get_logger();
...
CallbackReturn ErnestController::on_activate(const rclcpp_lifecycle::State &)
{
...
CallbackReturn ErnestController::on_deactivate(const rclcpp_lifecycle::State &)
{
  subscriber_is_active_ = false;
  return CallbackReturn::SUCCESS;
}

CallbackReturn ErnestController::on_cleanup(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return CallbackReturn::ERROR;
...
CallbackReturn ErnestController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return CallbackReturn::ERROR;
...
CallbackReturn ErnestController::on_shutdown(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

void ErnestController::halt()
{
...
CallbackReturn ErnestController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
  ernest_controller::ErnestController, controller_interface::ControllerInterface)
