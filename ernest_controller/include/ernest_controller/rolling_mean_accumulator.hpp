#ifndef ernest_CONTROLLER__ROLLING_MEAN_ACCUMULATOR_HPP_
#define ernest_CONTROLLER__ROLLING_MEAN_ACCUMULATOR_HPP_
...
#endif  // ernest_CONTROLLER__ROLLING_MEAN_ACCUMULATOR_HPP_
