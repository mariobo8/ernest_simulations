...
using CallbackReturn = ernest_controller::CallbackReturn;
...
class TestableErnestController : public ernest_controller::ErnestController
{
public:
  using ErnestController::ErnestController;
...
class TestErnestController : public ::testing::Test
{
protected:
  ...
  void SetUp() override
  {
    controller_ = std::make_unique<TestableErnestController>();
  ...
  const std::string controller_name = "test_ernest_controller";
  std::unique_ptr<TestableErnestController> controller_;
...
TEST_F(TestErnestController, configure_fails_without_parameters)
{
...
TEST_F(TestErnestController, configure_fails_with_only_left_or_only_right_side_defined)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, configure_fails_with_mismatching_wheel_side_size)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, configure_succeeds_when_wheels_are_specified)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, activate_fails_without_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, activate_succeeds_with_resources_assigned)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, cleanup)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
...
TEST_F(TestErnestController, correct_initialization_using_parameters)
{
  const auto ret = controller_->init(controller_name);
  ASSERT_EQ(ret, controller_interface::return_type::OK);
