...
%% loading
input_path = fullfile(pwd, '../../position_controller/4ws/sym/input.txt'); % Paths Folder
load(input_path)
state_path = fullfile(pwd, '../../position_controller/4ws/sym/state.txt'); % Paths Folder
load(state_path)
prediction_path = fullfile(pwd, '../../position_controller/4ws/sym/prediction.txt'); % Paths Folder
pred = load(prediction_path);
reference_path = fullfile(pwd, '../../position_controller/4ws/sym/reference.txt'); % Paths Folder
