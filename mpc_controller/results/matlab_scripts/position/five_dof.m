...
%% loading
%% loading
input_path = fullfile(pwd, '../../position_controller/5_dof/input.txt'); % Paths Folder
load(input_path)
state_path = fullfile(pwd, '../../position_controller/5_dof/state.txt'); % Paths Folder
load(state_path)
prediction_path = fullfile(pwd, '../../position_controller/5_dof/prediction.txt'); % Paths Folder
pred = load(prediction_path);
reference_path = fullfile(pwd, '../../position_controller/5_dof/reference.txt'); % Paths Folder
