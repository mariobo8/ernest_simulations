...
%% loading
input_path = fullfile(pwd, '../../position_controller/4ws/input.txt'); % Paths Folder
load(input_path)
state_path = fullfile(pwd, '../../position_controller/4ws/state.txt'); % Paths Folder
load(state_path)
prediction_path = fullfile(pwd, '../../position_controller/4ws/prediction.txt'); % Paths Folder
pred = load(prediction_path);
reference_path = fullfile(pwd, '../../position_controller/4ws/reference.txt'); % Paths Folder
