...
%% loading
input_path = fullfile(pwd, '../../../5_dof/input.txt'); % Paths Folder
load(input_path)
state_path = fullfile(pwd, '../../../5_dof/state.txt'); % Paths Folder
load(state_path)
prediction_path = fullfile(pwd, '../../../5_dof/prediction.txt'); % Paths Folder
...
load(fullfile(pwd, '../../../5_dof/steer_effort.txt'))
load(fullfile(pwd, '../../../5_dof/wheel_effort.txt'))
%% data
N = 10;
dt = 0.1;
lf = 0.16; lr = 0.71;
