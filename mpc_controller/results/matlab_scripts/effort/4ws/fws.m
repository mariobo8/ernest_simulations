...
%% loading
input_path = fullfile(pwd, '../../../4ws/input.txt'); % Paths Folder
load(input_path)
bicycle_path = fullfile(pwd, '../../../4ws/input_bicycle.txt'); % Paths Folder
load(bicycle_path)
state_path = fullfile(pwd, '../../../4ws/state.txt'); % Paths Folder
load(state_path)
prediction_path = fullfile(pwd, '../../../4ws/prediction.txt'); % Paths Folder
pred = load(prediction_path);
reference_path = fullfile(pwd, '../../../4ws/reference.txt'); % Paths Folder
ref = load(reference_path);
path_path = fullfile(pwd, '../../../../path/new_path.txt'); % Paths Folder
path = load(path_path);

load(fullfile(pwd, '../../../4ws/time_step.txt'))
load(fullfile(pwd, '../../../4ws/steer_effort.txt'))
load(fullfile(pwd, '../../../4ws/wheel_effort.txt'))
%% data
N = 10;
dt = 0.1;
lf = 0.16; lr = 0.71;
