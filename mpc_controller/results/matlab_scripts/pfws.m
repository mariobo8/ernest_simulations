...
%% loading
load(fullfile(pwd, '../4ws_pivot/input.txt'))
load(fullfile(pwd, '../4ws_pivot/time_step.txt'))
load(fullfile(pwd, '../4ws_pivot/wheel_effort.txt'))
load(fullfile(pwd, '../4ws_pivot/state.txt'))
load(fullfile(pwd, '../4ws_pivot/steer_effort.txt'))
pred_k = load(fullfile(pwd, '../4ws_pivot/prediction.txt'));
ref_k = load (fullfile(pwd, '../4ws_pivot/reference.txt'));
%% data
N = 10;
dt = 0.1;
lf = 0.16; lr = 0.71;
