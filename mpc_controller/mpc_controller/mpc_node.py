...
from .pivot_4ws_kinematics import AckermannKinematics as demo_mpc
import math
from .utils import *
...
class PathTrackingMPC(Node):
    ...
    def __init__(self):
        ...
        [self.solver, self.args, self.n_states, self.n_controls, self.f, self.f2] = self.mpc_inst.set_solver()
        #solver = self.solver
